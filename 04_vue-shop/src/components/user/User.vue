<template>
  <div>
    ...
    <!-- 添加用户对话框 -->
    <el-dialog title="添加用户" :visible.sync="addDialogVisible" @close="handleClose" width="50%">
      <!-- 内容主体区域 -->
      <el-form :model="newUser" :rules="newUserRules" ref="newUserRef" label-width="100px">
    ...
    <el-dialog title="修改用户" :visible.sync="editDialogVisible" width="50%" @close="editDialogClose">
      <!-- 对话框内容 -->
      <el-form :model="editUser" :rules="newUserRules" ref="editUserRef" label-width="70px">
